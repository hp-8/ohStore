    ...
    <>
      ...
      <div className="w-full bg-gray-100 dark:bg-gray-900">
        <div className="max-w-6xl min-h-screen m-auto p-4 dark:text-teal-50 bg-gray-100 dark:bg-gray-900">
          <h1 className="text-3xl font-semibold tracking-wider text-center mt-24 text-black dark:text-teal-50">
            Sell your Product
          </h1>
          <div className="mt-6">
                ...
                <form action="#" method="POST">
                  <div className="overflow-hidden shadow sm:rounded-md">
                    ...
                    <div className="bg-gray-50 px-4 py-3 text-right sm:px-6 dark:bg-gray-900 ">
                      ...
                      <button
                        type="submit"
                        className="md:inline-flex block w-full justify-center rounded-sm border border-transparent py-1 px-6 text-lg font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 bg-orange-700 bg-gradient-to-tr from-orange-700 to-yellow-400"
