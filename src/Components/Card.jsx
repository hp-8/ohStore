      ...
      <div className="w-full max-w-xs bg-white md:rounded border-2  shadow-xl dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="md:px-5 px-3 md:pb-5 pb-4">
          ...
          <Link to={product.id && `/product/${product.id}`}>
            <div className="h-8">
              {" "}
              <h5 className=" mt-4 md:text-md text-xs font-lg tracking-tight text-gray-900 text-black dark:text-white">
                {product.title}
              </h5>
            </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="md:font-bold text-white bg-yellow-500 tracking-tighter hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-yellow-300  rounded-lg text-xs md:text-sm md:px-5 px-2 md:py-2.5 py-1.5 text-center dark:bg-yellow-600 dark:hover:bg-orange-600 dark:focus:ring-yellow-800"
            >
              Add to cart
            </button>
          </div>
