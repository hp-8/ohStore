          ...
          <div className="mb-6 md:mb-0">
            <a href="#" className="flex items-center">
              {/* <img
                ...
                alt="Shopspot Logo"
              /> */}
              <span className="self-center text-2xl md:text-3xl font-semibold whitespace-nowrap text-transparent bg-clip-text bg-gradient-to-br from-yellow-400 to-orange-700">
            Oh Store!
              </span>
            </a>
          </div>
