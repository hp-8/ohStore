          ...
          <div className="order-last md:order-first mr-auto place-self-center lg:col-span-7">
            ...
            <div className="text-center">
              <Link to={"/products/electronics"}>
                <button
                  type="button"
                  className="py-2 px-8 text-lg font-semibold font-sen uppercase text-orange-700  border-orange-700 border-2 bg-transparent hover:bg-orange-700 hover:text-white focus:ring-4 focus:ring-orange-300 dark:bg-transparent dark:hover:bg-orange-700 focus:outline-none dark:focus:ring-orange-800"
                >
                  Shop now
                </button>
              </Link>
