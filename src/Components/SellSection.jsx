          ...
          <div className="max-w-same flex flex-col justify-center text-teal-100">
            ...
            <div className="text-center">
              <Link to={"/sell"}>
                ...
                >
                  <span className="cursor-pointer block text-gray-100  md:px-16 px-10 md:py-2 py-1.5 font-semibold bg-gray-900 bg-opacity-5 uppercase hover:bg-opacity-0 dark:bg-opacity-0">
                    Sell
                  </span>
                </button>
              </Link>
